...
* 输入项目名称与选择项目框架
  * Project name: … Vue3+Vite3
  * Select a framework: › vue
  * Select a variant: › TypeScript 或 选择 Customize with create-vue 进行快速自定义配置
  <img :src="$withBase('/imgs/vite_1.jpg')" alt="vite_1">
...
4. 选择安装方式
  ...
  <img :src="$withBase('/imgs/vite_3.jpg')" alt="vite_3">
...
#### 二、配置.prettierrc.json

1. Vscode安装 `PrettierConfig for VS Code`插件

  <img :src="$withBase('/imgs/vite_2.gif')" alt="vite_2">
  将.prettierrc.js文件改为json文件
